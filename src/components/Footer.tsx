  ...
  return (
    <footer>
      ...
      <div className="bg-navy py-5">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-4 px-6 text-center md:grid-cols-3 md:text-left lg:px-10">
          ...
          <div className="flex flex-col items-center gap-3 md:flex-row md:items-center md:gap-4">
            ...
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/WatchSleekMedia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                className="text-white/60 transition hover:text-teal">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/watchsleekmedia" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                className="text-white/60 transition hover:text-teal">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <a href="https://www.tiktok.com/@sleek.media" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                className="text-white/60 transition hover:text-teal">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
