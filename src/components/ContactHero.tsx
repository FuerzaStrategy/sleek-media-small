...
export default function ContactHero() {
  ...
  return (
    <section className="relative overflow-hidden">
      {/* Background */}
      <Image
        src={`/images/contact/contact_hero.webp`}
        alt=""
        fill
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-20 md:grid-cols-2 lg:px-10 lg:py-28">
        ...
        <div className="flex flex-col justify-center">
          ...
          <ul className="mt-10 space-y-4">
            ...
            <li className="flex items-center gap-3">
              <a href="https://www.facebook.com/WatchSleekMedia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="transition hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  className="h-5 w-5 flex-shrink-0" style={{ color: "#AAD3DF" }}>
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987H7.898V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/watchsleekmedia" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="transition hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  className="h-5 w-5 flex-shrink-0" style={{ color: "#AAD3DF" }}>
              ...
              <a href="https://www.tiktok.com/@sleek.media" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="transition hover:opacity-75">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  className="h-5 w-5 flex-shrink-0" style={{ color: "#AAD3DF" }}>
