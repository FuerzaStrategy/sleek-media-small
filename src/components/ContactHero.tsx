        ...
        <div className="flex flex-col justify-center">
          ...
          <ul className="mt-10 space-y-4">
            <li className="flex items-center gap-3">
              <Image
                src={`${BASE}/images/contact/Icon awesome-phone-alt.svg`}
                alt=""
                width={18}
                height={18}
                className="invert"
              />
              <a
                href="tel:18622285125"
                className="text-white/90 transition hover:text-teal"
              >
                1.862.228.5125
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Image
                src={`${BASE}/images/contact/Icon material-email.svg`}
                alt=""
                width={20}
                height={16}
                className="invert"
              />
              <a
                href="mailto:Hello@WatchSleek.com"
                className="text-white/90 transition hover:text-teal"
              >
